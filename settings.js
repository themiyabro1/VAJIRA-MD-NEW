...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=3VdykIiQ#pVLgg5Dlc9zw405Ztk2FtJB60PHICEjC8W-zr0-l6FE' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '94769880718' : process.env.OWNER_NUMBER,   
...
MAX_SIZE: 500, 
ALIVE:  process.env.ALIVE  || 'Hey I Am ༺𝙈𝙧.𝙏𝙝𝙚𝙢𝙞𝙮𝙖 (𝙋𝙑𝙏 𝘽𝙤𝙩)༻ Online Now ✅'  ,    
